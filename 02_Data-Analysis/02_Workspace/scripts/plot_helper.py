...
def visualize_screeplot(id, x_axis, y_axis):
    ...
    plt.grid()
    # Export as .png
    png_file = "../../OUTPUT/PCA-plots_Next-Generation-Sequencing/Screeplots/Screeplot_" + id + ".png"
...
def visualize_qqplot(title = "Unknown", data = None):
    ...
    # Export
    png_file = "../../OUTPUT/Raw-Data/Data-Statistics/QQ-Plots/QQ-Plots_" + title + "_Normal-Distribution"
    plt.savefig(png_file, bbox_inches = "tight")
    plt.close()
